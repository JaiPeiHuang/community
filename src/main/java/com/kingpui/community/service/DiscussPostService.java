...
import com.kingpui.community.util.SensitiveFilter;
...
public class DiscussPostService {
    ...
    public void  init(){
        ...
        postListCache = Caffeine.newBuilder().
                maximumSize(maxSize)
                .expireAfterWrite(expireSecounds, TimeUnit.SECONDS)
                .build(new CacheLoader<String, List<DiscussPost>>() {
                    ...
                    public List<DiscussPost> load(String key) throws Exception {
                        ...
                        return disscussPostMapper.selectDiscussPosts(0,offset,limit,1);
                    }
                });
    ...
    public int updateScore(int postId,double score){
        return disscussPostMapper.updateScore(postId,score);
    }
}
